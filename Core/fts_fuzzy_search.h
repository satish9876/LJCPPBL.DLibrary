...
#ifndef LJINDOORANDROIDSDK_FTS_FUZZY_SEARCH_H
#define LJINDOORANDROIDSDK_FTS_FUZZY_SEARCH_H

#endif //LJINDOORANDROIDSDK_FTS_FUZZY_SEARCH_H
...
namespace fts {
    ...
    static bool fuzzy_match(char const * pattern, char const * str, int & outScore, int * matches, int maxMatches);
}
